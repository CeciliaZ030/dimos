...
all_blueprints = {
    ...
    "unitree-go2-agentic-relocalization": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_agentic_relocalization:unitree_go2_agentic_relocalization",
...
all_modules = {
    ...
    "blind-assistant-skill-container": "dimos.agents.skills.blind_assistant_skills.BlindAssistantSkillContainer",
    ...
    "guide-web-input": "dimos.agents.guide_web_input.GuideWebInput",
